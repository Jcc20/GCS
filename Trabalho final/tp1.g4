...
@after{
       ...
       $iterator=1;
       if (idadeAluno!=0) System.out.println("\nAs "+ntop+" melhores opções para o aluno " + numAluno + " aprender o conceito " + $conc + " são:\n");
      ...
      HashMap<Integer,Double>       top                  = new HashMap<Integer,Double>();
          ...
          (aluno
           ...
           )+
           {
            ...
            else System.out.println("\nAluno " + numAluno + " com idade " + idadeAluno + " e as suas caracteristicas são " + caracteristicasAluno);
           }
           (recursoAprendizagem
            {
            if(idadeAluno!=0){
